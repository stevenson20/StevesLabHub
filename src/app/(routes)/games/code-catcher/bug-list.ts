...
export const bugList: BugSnippet[] = [
  ...
  },
  {
    ...
    code: [
      ...
      '    if item % 2 == 0:',
      '        my_list.remove(item)',
      '# This will not remove all even numbers',
    ],
    buggyLine: 4,
  ...
  },
  {
    ...
    buggyLine: 1,
    explanation: 'The `+` operator performs string concatenation if one of the operands is a string. To ensure mathematical addition, explicitly convert the string to a number using `parseInt()` or `Number()`.',
    difficulty: 'easy',
  },
  {
    id: 10,
    ...
    code: [
      ...
      '    if n % 2 == 0:',
      '      return n',
      '# Returns only the first even number',
    ],
    buggyLine: 4,
  ...
  },
  {
    ...
    code: [
      ...
      '  num * 2;',
      '});',
      '// doubled is [undefined, undefined, undefined]',
    ],
    buggyLine: 3,
  ...
  },
  {
    ...
    code: [
      ...
      '# Raises TypeError because age is None',
    ],
    buggyLine: 3,
  ...
  },
  {
    ...
    code: [
      ...
      '}',
      '// This always logs, even if the array is empty.',
    ],
    buggyLine: 2,
  ...
  },
  {
    ...
    code: [
      ...
      '# double_result = result * 2 # This will fail',
    ],
    buggyLine: 4,
